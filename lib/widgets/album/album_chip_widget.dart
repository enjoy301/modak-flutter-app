...
class AlbumChipWidget extends StatelessWidget {
  const AlbumChipWidget({required this.title, required this.isSelected, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: isSelected ? Coloring.gray_20 : Coloring.gray_40, borderRadius: BorderRadius.circular(30)),
      child: Text(
        title,
