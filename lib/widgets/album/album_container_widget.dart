  ...
  Widget build(BuildContext context) {
    Map<String, dynamic> data = {
      "messenger": {
        ...
        "file": context.watch<AlbumProvider>().messengerThumbnail,
      },
      "todo": {
        "title": "집안일 완료 앨범",
        "image": "lib/assets/images/others/empty_todo_album.png",
        "file": context.watch<AlbumProvider>().todoThumbnail,
      },
    };
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: ClipRRect(
                ...
                child: AspectRatio(
                  aspectRatio: 1.47,
                  child: data[widget.type]['file'] != null
                      ? Image.file(data[widget.type]['file'],
