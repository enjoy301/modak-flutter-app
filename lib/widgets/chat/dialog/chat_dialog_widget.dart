              ...
              child: Row(
                ...
                children: [
                  !isMine && widget.isHead
                      ? Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Get.to(UserFamilyModifyScreen(familyMember: userProvider.findUserById(widget.chat.userId)!));
                          },
                          child: Image.asset(
                  ...
                  widget.chat.metaData!['type_code'] == 'plain'
                      ? DialogBubbleWidget(chat: widget.chat, isMine: isMine, isHead: widget.isHead,)
