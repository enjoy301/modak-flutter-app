...
class TodoWriteScreen extends StatefulWidget {
  const TodoWriteScreen({Key? key, this.title, this.manager, this.date}) : super(key: key);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InputSelectWidget(
                            title: "담당",
                            contents: manager == null ? userProvider.me!.name : manager!.name,
                            isFilled: true,
                            buttons: {
                              for (User familyMember in userProvider.familyMembers)
                                familyMember.name: () {
                                  setState(() {
